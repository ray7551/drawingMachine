...
var defaultColors = ["#FFFFFF", "#FFEB3B", "#FFC107", "#FF9800", "#FF5722", "#795548", "#607D8B", "#F44336", "#E91E63", "#9C27B0", "#673AB7", "#3F51B5", "#2196F3", "#03A9F4", "#00BCD4", "#009688", "#4CAF50", "#8BC34A", "#CDDC39"];

var Palette = function () {
  function Palette() {
    var colors = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultColors;
  ...
  _createClass(Palette, [{
    key: "mix",
    value: function mix(time, period) {
      var changedTimes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

      time = Math.abs(time);
      var index = (Math.floor(time / period) + changedTimes) % (this.colors.length - 1);
      return this.colors[index].mix(this.colors[index + 1], time % period / period // mix rate
      ).string();
    }
  }]);
